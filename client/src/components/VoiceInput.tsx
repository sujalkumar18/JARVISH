      ...
      <div className="glass-card border-white/20 shadow-2xl rounded-2xl p-4">
        <form onSubmit={handleSubmit} className="flex items-center gap-3">
          ...
          <button 
            ...
            className={`w-12 h-12 rounded-2xl flex items-center justify-center relative transition-all duration-300 hover:scale-110 shadow-lg ${
              listening 
          ...
          >
            ...
            {listening ? (
              <StopCircle className="text-white h-5 w-5 z-10" />
            ) : (
        ...
        {listening && (
          <div className="mt-3 text-center animate-fade-in">
            <p className="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">🎤 Listening...</p>
